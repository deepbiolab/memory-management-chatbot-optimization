...
int main() {
  ...
  // MyMovableClass obj3(obj1);  // copy constructor, obj1 is lvalue

  // MyMovableClass obj4 = obj1;  // copy constructor, obj1 is lvalue, obj4 is
  // lvalue reference
  ...
  // obj1 = MyMovableClass(
  //     200);  // move assignment operator, MyMovableClass(200) is rvalue

  // MyMovableClass obj2 =
  //     MyMovableClass(300);  // move constructor, MyMovableClass(300) is
  //     rvalue
